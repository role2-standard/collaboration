...
什么是目标？目标就是**将某个事物维持在某种理想状态**，通常需要做功实现。
...
所有目标的首要隐含子目标是 "广播目标"，通常表现为软件中的 "创建任务"，良好的书面化有利于：

- 让队友有明确的预期（"他在画图，明天完成，那我先把网页结构写好，明天替换上去"）
- 后续评估工作价值
- 引用价值
...
谁主导达成这个目标。除了负责人，还可以指定相关人员，当目标状态发生改变时（完成状态，预期时间等等）应该知会相关人。
...
凡是不能在 10 分钟内完成的都需要创建任务。这包括思考、规划等看不到的工作。
